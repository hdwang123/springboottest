...
import com.hdwang.dao.jdbc.TestDao;
...
public class Test {
    ...
    public void testTransaction2(boolean throwEx){
        this.testDao.testTransactionManually2(throwEx);
    }

    @RequestMapping("jdbc2")
    public void testJdbc2(){
        this.testDao.testJdbcTemplate2();
    }
